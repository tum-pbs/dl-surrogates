...
def LoaderNormalizer(data, isTest = False, shuffle = 0, dataProp = None):
    ...
    if fixedAirfoilNormalization:
        ...
        data.max_inputs_0 = 0.
        data.max_inputs_1 = 0.01
        data.max_inputs_2 = 1.0

        # targets depend on normalization
        if makeDimLess: #[1.1359899999999998, 0.6168279999999999, 1.24844]
            data.max_targets_0 = 1.13598
            data.max_targets_1 = 0.61682
            data.max_targets_2 = 1.24844
